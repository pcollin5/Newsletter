...
total_24 <- Module_4_Section_B %>%
  filter(Year == 2024)%>%
  summarise(Total = sum(Count))

all_total_24 <- total_24$Total
...
program_percent_24 <- Module_4_Section_B %>%
  filter(Year == 2024)%>%
  group_by(Program)%>%
  mutate(`Program Total` = sum(Count))%>%
  reframe(`2024` = round(100*`Program Total` / all_total_24,2))%>%
  unique()
...
joined_program_percent <- full_join(program_percent_24, program_percent_23)
...
m4sb_programs_percent_of_total <- joined_program_percent_with_difference %>%
  ...
  labs(y = " ", x = " ")+
  ggtitle("Module 4 Section B 2022-2023 and 2023-2024 Program Year Percent of Community Service")
...
m4sb_percent_change_program_of_total <- joined_program_percent_with_difference %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SB 2022-2023 and 2023-2024 Program Year Percent of Community Service Difference")
...
m4sb_program_totals <- Module_4_Section_B %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SB 2022-2023 and 2023-2024 Program Year by Program")
...
m4sb_sub_program_totals <- Module_4_Section_B %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SB 2022-2023 and 2023-2024 Program Year by Program Group")
...
emp_24 <- Module_4_Section_B %>%
  filter(Program == "Employment Service")%>%
  filter(Year == 2024)%>%
  summarise(Total = sum(Count))

emp_total_24 <- emp_24$Total  

emp_subprogram_24 <- Module_4_Section_B%>%
  filter(Program == "Employment Service")%>%
  filter(Year == 2024)%>%
  group_by(`Sub-Program`)%>%
  mutate(`2024 Subprogram Count` = sum(Count))%>%
  mutate(`2024 Subprogram Percent` = round(100*`2024 Subprogram Count` / emp_total_24,2))%>%
  ungroup()%>%
  mutate(`2024 Service Percent` = round(100*(Count) / emp_total_24,2))




edu_24 <- Module_4_Section_B %>%
  filter(str_detect(Program, "Education"))%>%
  filter(Year == 2024)%>%
  summarise(Total = sum(Count))

edu_total_24 <- edu_24$Total

edu_subprogram_24 <- Module_4_Section_B%>%
  filter(str_detect(Program, "Education"))%>%
  filter(Year == 2024)%>%
  group_by(`Sub-Program`)%>%
  mutate(`2024 Subprogram Count` = sum(Count))%>%
  mutate(`2024 Subprogram Percent` = round(100*`2024 Subprogram Count` / edu_total_24,2))%>%
  ungroup()%>%
  mutate(`2024 Service Percent` = round(100*(Count) / edu_total_24,2))

edu_subprogram_24

income_24 <- Module_4_Section_B %>%
  filter(Year == 2024)%>%
  filter(str_detect(Program, "Income"))%>%
  summarise(Total = sum(Count))

income_total_24 <- income_24$Total

income_total_24

income_subprogram_24 <- Module_4_Section_B%>%
  filter(str_detect(Program, "Income"))%>%
  filter(Year == 2024)%>%
  group_by(`Sub-Program`)%>%
  mutate(`2024 Subprogram Count` = sum(Count))%>%
  mutate(`2024 Subprogram Percent` = round(100*`2024 Subprogram Count` / income_total_24,2))%>%
  mutate(`2024 Service Percent` = round(100*(Count) / income_total_24,2))

income_subprogram_24


housing_24 <- Module_4_Section_B %>%
  filter(Year == 2024)%>%
  filter(str_detect(Program, "Housing"))%>%
  summarise(Total = sum(Count))

housing_total_24 <- housing_24$Total

housing_subprogram_24 <- Module_4_Section_B%>%
  filter(str_detect(Program, "Housing"))%>%
  filter(Year == 2024)%>%
  group_by(`Sub-Program`)%>%
  mutate(`2024 Subprogram Count` = sum(Count))%>%
  mutate(`2024 Subprogram Percent` = round(100*`2024 Subprogram Count` / housing_total_24,2))%>%
  mutate(`2024 Service Percent` = round(100*(Count) / housing_total_24,2))

housing_subprogram_24


health_24 <- Module_4_Section_B %>%
  filter(Year == 2024)%>%
  filter(str_detect(Program, "Health"))%>%
  summarise(Total = sum(Count))

health_total_24 <- health_24$Total

health_subprogram_24 <- Module_4_Section_B%>%
  filter(str_detect(Program, "Health"))%>%
  filter(Year == 2024)%>%
  group_by(`Sub-Program`)%>%
  mutate(`2024 Subprogram Count` = sum(Count))%>%
  mutate(`2024 Subprogram Percent` = round(100*`2024 Subprogram Count` / health_total_24,2))%>%
  mutate(`2024 Service Percent` = round(100*(Count) / health_total_24,2))


health_subprogram_24

multi_24 <- Module_4_Section_B %>%
  filter(Year == 2024)%>%
  filter(str_detect(Program, "Multiple"))%>%
  summarise(Total = sum(Count))

multi_total_24 <- multi_24$Total

multi_subprogram_24 <- Module_4_Section_B%>%
  filter(str_detect(Program, "Multiple"))%>%
  filter(Year == 2024)%>%
  group_by(`Sub-Program`)%>%
  mutate(`2024 Subprogram Count` = sum(Count))%>%
  mutate(`2024 Subprogram Percent` = round(100*`2024 Subprogram Count` / multi_total_24,2))%>%
  mutate(`2024 Service Percent` = round(100*(Count) / multi_total_24,2))


civic_24 <- Module_4_Section_B %>%
  filter(Year == 2024)%>%
  filter(str_detect(Program, "Civic"))%>%
  summarise(Total = sum(Count))

civic_total_24 <- civic_24$Total

civic_subprogram_24 <- Module_4_Section_B%>%
  filter(str_detect(Program, "Civic"))%>%
  filter(Year == 2024)%>%
  group_by(`Sub-Program`)%>%
  mutate(`2024 Subprogram Count` = sum(Count))%>%
  mutate(`2024 Subprogram Percent` = round(100*`2024 Subprogram Count` / civic_total_24,2))%>%
  mutate(`2024 Service Percent` = round(100*(Count) / civic_total_24,2))
...
subprograms_24 <- rbind(emp_subprogram_24, edu_subprogram_24, income_subprogram_24, housing_subprogram_24, health_subprogram_24, multi_subprogram_24,
                        civic_subprogram_24)%>%
  select(!Year)%>%
  rename("2024 Service Count" = "Count")
...
joined_percents <- full_join(subprograms_24, subprograms_23, by = c("Program", "Sub-Program", "Service"))

names(joined_percents)

mutated_joined_percents <- joined_percents %>%
  mutate(`Service Percent Change` = round(100*(`2024 Service Count` - `2023 Service Count`) / `2023 Service Count`,2))%>%
  mutate(`Service Percent Difference` = `2024 Service Percent` - `2023 Service Percent`)%>%
  mutate(`Subprogram Percent Change` = round(100*(`2024 Subprogram Count` - `2023 Subprogram Count`)/ `2023 Subprogram Count`,2))%>%
  mutate(`Subprogram Percent Difference` = `2024 Subprogram Percent` - `2023 Subprogram Percent`)
...
m4sb_emp_income_service_totals <- long_joined_percents %>%
  ...
  ggtitle("Module 4 Section B 2022-2023 and 2023-2024 Program Year Totals by Service")
...
m4sb_emp_income_serivce_percent_of_program <- long_joined_percents %>%
  ...
  ggtitle("Module 4 Section B 2022-2023 and 2023-2024 Program Year Service of Program")
...
m4sb_emp_income_service_percent_change <- long_joined_percents %>%
  ...
  ggtitle("Module 4 Section B 2022-2023 and 2023-2024 Program Year Percent Change in Service Totals")
...
m4sb_emp_income_service_percent_of_program_change <- long_joined_percents %>%
  ...
  ggtitle("Module 4 Section B 2022-2023 and 2023-2024 Program Year Difference in Percent of Program")
...
m4sb_housing_service_totals <- long_joined_percents %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SB 2022-2023 and 2023-2024 Program Year Totals by Service")
...
m4sb_housing_service_percent_of_program <- long_joined_percents %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SB 2022-2023 and 2023-2024 Program Year Service of Program")
...
m4sb_housing_service_percent_change <- long_joined_percents %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SB 2022-2023 and 2023-2024 Program Year Percent Change in Service Totals")
...
m4sb_housing_service_percent_of_program_difference <- long_joined_percents %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SB 2022-2023 and 2023-2024 Program Year Difference in Percent of Program")
...
m4sb_health_service_percent_of_program <- long_joined_percents %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SB 2022-2023 and 2023-2024 Program Year Service Percent of Program")
...
Module_4_Section_B %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SB 2022-2023 and 2023-2024 Program Year by Service")

m4sb_service_24 <-Module_4_Section_B %>%
  mutate(Year = factor(Year, levels = c("2023", "2024")))%>%
  filter(Year == 2024)%>%
  ungroup()%>%
  select(!Year)%>%
...
names(m4sb_service_23)

joined_m4sb_service <- left_join(m4sb_service_24, m4sb_service_23, by = c("Program", "Sub-Program", "Service"))

percent_change_m4sb_service <- joined_m4sb_service %>%
  mutate(Change = `2024 Service Count` - `2023 Service Count`)%>%
  mutate(`Percent Change` = round(100*Change / `2023 Service Count`,2))
...
percent_change_m4sb_service %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SB 2022-2023 and 2023-2024 Percent Change in Program Year by Service")
...
m4sb_program_24 <-Module_4_Section_B %>%
  filter(Year != 2022)%>%
  mutate(Year = factor(Year, levels = c("2023", "2024")))%>%
  group_by(Year, `Program`)%>%
  mutate(`Program Count` = sum(Count))%>%
  ...
  ungroup()%>%
  select(!c(Count, Year))%>%
  rename("2024 Program Count" = `Program Count`)
...
joined_m4sb_program <- left_join(m4sb_program_24, m4sb_program_23, by = c("Program", "Sub-Program", "Service"))

percent_change_m4sb_program <- joined_m4sb_program %>%
  mutate(Change = `2024 Program Count` - `2023 Program Count`)%>%
  mutate(`Percent Change` = round(100*Change / `2023 Program Count`,2))
...
m4sb_programs_percent_change <- percent_change_m4sb_program %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SB 2023-2023 and 2023-2024 Percent Change in Program Year by Program")
...
m4sc_total <- Module_4_Section_C %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Total")

m4sc_total

m4sc_total_24 <- Module_4_Section_C %>%
  filter(Subgroup == "Total")%>%
  filter(Year == 2024)%>%
  rename("2024 Count" = "Count")%>%
  select(!Year)
...
m4sc_total_joined <- left_join(m4sc_total_24, m4sc_total_23, by = c("Group", "Subgroup", "Measure"))

m4sc_total_joined

percent_change_m4sc_total_joined <- m4sc_total_joined %>%
  mutate(Change = `2024 Count` - `2023 Count`)%>%
  mutate(`Percent Change` = round(100*Change / `2023 Count`,2))%>%
  filter(!is.nan(`Percent Change`))

percent_change_m4sc_total_joined
...
m4sc_total_percent_change <- percent_change_m4sc_total_joined %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Total Percent Change")
...
total_24_pre <- gender_age_total %>%
  filter(Year == 2024)

total_23 <- total_23_pre$Total

total_24 <- total_24_pre$Total
...
m4sc_age_gender_totals <- Module_4_Section_C %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Age and Gender")

m4sc_age_gender_totals

m4sc_age_gender_24 <- Module_4_Section_C %>%
  filter(Subgroup == "Gender"|
           Subgroup == "Age")%>%
...
names(m4sc_age_gender_24)

m4sc_age_gender_joined <- left_join(m4sc_age_gender_24, m4sc_age_gender_23, by = c("Group", "Subgroup", "Measure"))
...
m4sc_age_gender_percent_change <- percent_change_m4sc_age_gender_joined %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Percent Change in in Age and Gender")

m4sc_age_gender_percent_change

m4sc_age_gender_24_percent <- m4sc_age_gender_24 %>%
  mutate(`2024 Percent` = round(100*`2024 Count` / total_24,2))

m4sc_age_gender_23_percent <- m4sc_age_gender_23 %>%
  mutate(`2023 Percent` = round(100*`2023 Count` / total_23,2))

joined_m4sc_age_gender_percent <- left_join(m4sc_age_gender_24_percent, m4sc_age_gender_23_percent, by = c("Group", "Subgroup", "Measure"))
...
m4sc_age_gender_percent_of_total <- long_joined_m4sc_age_gender %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Age and Gender Percentages")
...
m4sc_education_totals <- Module_4_Section_C %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Education")

m4sc_education_totals


m4sc_edu_1424_24 <- Module_4_Section_C %>%
  filter(Subgroup == "Education")%>%
  filter(Year == 2024)%>%
  filter(str_detect(Measure, "14-24"))%>%
  summarise(Total = sum(Count))

m4sc_edu_1424_total_24 <- m4sc_edu_1424_24$Total


m4sc_edu_25_24 <- Module_4_Section_C %>%
  filter(Subgroup == "Education")%>%
  filter(Year == 2024)%>%
  filter(str_detect(Measure, "14-24", negate = TRUE))%>%
  summarise(Total = sum(Count))

m4sc_edu_25_total_24 <- m4sc_edu_25_24$Total
...
m4sc_edu_25_total_23


m4sc_education_24_u25 <- Module_4_Section_C %>%
  filter(Subgroup == "Education")%>%
  filter(Year == 2024)%>%
  filter(str_detect(Measure, "14-24"))%>%
  mutate(`2024 Percent Under 25` = round(100*Count / m4sc_edu_1424_total_24,2))%>%
  rename("2024 Count Under 25" = "Count")%>%
  select(!Year)

m4sc_education_24_25over <- Module_4_Section_C %>%
  filter(Subgroup == "Education")%>%
  filter(Year == 2024)%>%
  filter(str_detect(Measure, "14-24", negate = TRUE))%>%
  mutate(`2024 Percent 25+` = round(100*Count / m4sc_edu_25_total_24,2))%>%
  rename("2024 Count 25+" = "Count")%>%
  select(!Year)
...
m4sc_education_25over_joined <- left_join(m4sc_education_24_25over, m4sc_education_23_25over, by = c("Group", "Subgroup", "Measure"))

m4sc_education_u25_joined <- left_join(m4sc_education_24_u25, m4sc_education_23_u25, by = c("Group", "Subgroup", "Measure"))

m4sc_education_25over_percent_change <- m4sc_education_25over_joined %>%
  mutate(`Percent Change 25+` = round(100*(`2024 Count 25+` - `2023 Count 25+`)/ `2023 Count 25+`,2))

m4sc_education_u25_percent_change <- m4sc_education_u25_joined %>%
  mutate(`Percent Change Under 25` = round(100*(`2024 Count Under 25` - `2023 Count Under 25`)/ `2023 Count Under 25`,2))
...
m4sc_education_25over_percent <- long_m4sc_education_25over %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Education Percentages")
...
m4sc_education_u25_percent <- long_m4sc_education_u25 %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Under 25 Education Percentages")
...
m4sc_u25_education_percent_change_graph <- long_m4sc_education_u25_percent_change  %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Under 25 Years Education Percent Change")
...
m4sc_o25_education_percent_change_graph <- long_m4sc_education_25over_percent_change  %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Over 25 Years Education Percent Change")
...
m4sc_race_ethnicity_totals <- Module_4_Section_C %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Ethnicity/Race")


m4sc_race_ethnicity_totals


m4sc_race_24 <- Module_4_Section_C %>%
  filter(Subgroup == "Ethnicity/Race")%>%
  filter(Year == 2024)%>%
  summarise(Total = sum(Count))

m4sc_race_total_24 <- m4sc_race_24$Total
...
m4sc_race_ethnicity_24 <- Module_4_Section_C %>%
  filter(Subgroup == "Ethnicity/Race")%>%
  filter(Year == 2024)%>%
  mutate(`2024 Percent` = round(100*Count / m4sc_race_total_24, 2))%>%
  rename("2024 Count" = "Count")%>%
  filter(Measure != "Unknown")%>%
  select(!Year)
...
m4sc_race_ethnicity_joined <- left_join(m4sc_race_ethnicity_24, m4sc_race_ethnicity_23, by = c("Group", "Subgroup", "Measure"))

m4sc_race_ethnicity_joined

m4sc_race_ethnicity_percent_change <- m4sc_race_ethnicity_joined %>%
  mutate(`Percent Change` = round(100*(`2024 Count` - `2023 Count`)/ `2023 Count`,2))
...
long_m4sc_race_ethnicity_percent_change %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Race/Ethnicity Percentages")
...
m4sc_race_ethnicity_percent_change <- long_m4sc_race_ethnicity_percent_change %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Race/Ethnicity Percent Change")
...
m4sc_work_status <- Module_4_Section_C %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Work Status")

m4sc_work_status

m4sc_work_status_24 <- Module_4_Section_C %>%
  filter(Subgroup == "Work Status (18+)")%>%
  filter(Year == 2024)%>%
  summarise(Total = sum(Count))

m4sc_work_status_total_24 <- m4sc_work_status_24$Total
...
m4sc_work_status_percent_24 <- Module_4_Section_C %>%
  filter(Subgroup == "Work Status (18+)")%>%
  filter(Year == 2024)%>%
  mutate(`2024 Percent` = round(100*Count / m4sc_work_status_total_24, 2))%>%
  rename("2024 Count" = "Count")%>%
  filter(Measure != "Unknown")%>%
  select(!Year)
...
m4sc_work_status_joined <- left_join(m4sc_work_status_percent_24, m4sc_work_status_percent_23, by = c("Group", "Subgroup", "Measure"))
...
m4sc_work_status_percent <- long_m4sc_work_status_percent_change %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Work Status Percentages")
...
m4sc_work_status_percent_change <- long_m4sc_work_status_percent_change %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Work Status Percent Change")
...
m4sc_mil_disconnected_youth_totals <- Module_4_Section_C %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC Characteristics: Military Status and Disconnected Youth")

m4sc_mil_disconnected_youth_totals



m4sc_mil_24 <- Module_4_Section_C %>%
  filter(str_detect(Measure, "Military"))%>%
  filter(Year == 2024)%>%
  summarise(Total = sum(Count))

m4sc_mil_total_24 <- m4sc_mil_24$Total
...
m4sc_discon_24 <- Module_4_Section_C %>%
  filter(str_detect(Measure, "Disconnected"))%>%
  filter(Year == 2024)%>%
  summarise(Total = sum(Count))

m4sc_discon_total_24 <- m4sc_discon_24$Total

m4sc_discon_total_24



m4sc_mil_dis_24 <- Module_4_Section_C %>%
  filter(Subgroup == "Miltary Status"|
           Subgroup == "Disconnected Youth")%>%
  filter(Year == 2024)%>%
  rename("2024 Count" = "Count")%>%
...
m4sc_mil_dis_joined <- left_join(m4sc_mil_dis_24, m4sc_mil_dis_23, by = c("Group", "Subgroup", "Measure"))
...
long_m4sc_mil_dis_percent_change %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Military Service and Disconnected Youth Percentages")
...
m4sc_disability_totals_graph <- Module_4_Section_C %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Disability")

m4sc_disability_totals_graph



m4sc_disability_24 <- Module_4_Section_C %>%
  filter(str_detect(Measure, "Disabling"))%>%
  filter(Year == 2024)%>%
  summarise(Total = sum(Count))

m4sc_disability_total_24 <- m4sc_disability_24$Total
...
m4sc_disability_percents_24 <- Module_4_Section_C %>%
  filter(str_detect(Measure, "Disabling"))%>%
  filter(Year == 2024)%>%
  mutate(`2024 Percent` = round(100*Count / m4sc_disability_total_24, 2))%>%
  rename("2024 Count" = "Count")%>%
  filter(Measure != "Unknown")%>%
  select(!Year)
...
m4sc_disability_joined <- left_join(m4sc_disability_percents_24, m4sc_disability_percents_23, by = c("Group", "Subgroup", "Measure"))
...
m4sc_health_ins_24 <- Module_4_Section_C %>%
  filter(Subgroup == "Health")%>%
  filter(str_detect(Measure, "Disabling", negate = TRUE))%>%
  filter(Year == 2024)%>%
  summarise(Total = sum(Count))

m4sc_health_ins_total_24 <- m4sc_health_ins_24$Total
...
m4sc_health_ins_percents_24 <- Module_4_Section_C %>%
  filter(Subgroup == "Health")%>%
  filter(str_detect(Measure, "Disabling", negate = TRUE))%>%
  filter(Year == 2024)%>%
  mutate(`2024 Percent` = round(100*Count / m4sc_health_ins_total_24, 2))%>%
  rename("2024 Count" = "Count")%>%
  filter(Measure != "Unknown")%>%
  select(!Year)
...
m4sc_health_ins_joined <- left_join(m4sc_health_ins_percents_24, m4sc_health_ins_percents_23, by = c("Group", "Subgroup", "Measure"))
...
m4sc_disability_and_health_insurance_graph <- long_m4sc_disability_and_health_ins %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Disability and Health Insurance")
...
m4sc_disability_health_ins_percent_change <- long_m4sc_disability_and_health_ins %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Disability and Health Insurance Percent Change")
...
m4sc_health_ins_totals_graphs <- Module_4_Section_C %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Health Insurance Sources")

m4sc_health_ins_totals_graphs

m4sc_health_ins_type_24 <- Module_4_Section_C %>%
  filter(Subgroup == "Health Insurance Sources")%>%
  filter(Year == 2024)%>%
  summarise(Total = sum(Count))

m4sc_health_ins_type_total_24 <- m4sc_health_ins_type_24$Total

m4sc_health_ins_type_total_24
...
m4sc_health_ins_type_24 <- Module_4_Section_C %>%
  filter(Subgroup == "Health Insurance Sources")%>%
  filter(Year == 2024)%>%
  mutate(`2024 Percent` = round(100*Count / m4sc_health_ins_type_total_24, 2))%>%
  rename("2024 Count" = "Count")%>%
  filter(Measure != "Unknown")%>%
  select(!Year)
...
m4sc_health_ins_type_joined <- left_join(m4sc_health_ins_type_24, m4sc_health_ins_type_23, by = c("Group", "Subgroup", "Measure"))
...
m4sc_health_ins_percent_graph <- long_m4sc_health_ins_type_percent_change %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Health Insurance Sources Percentages")
...
m4sc_health_ins_percent_change_graph <-long_m4sc_health_ins_type_percent_change %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Health Insurance Sources Percent Change")
...
m4sc_hh_type_count_graph <- Module_4_Section_C %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Household Type")

m4sc_hh_type_count_graph

m4sc_hh_24 <- Module_4_Section_C %>%
  filter(Subgroup == "Household Type")%>%
  filter(Year == 2024)%>%
  summarise(Total = sum(Count))

m4sc_hh_total_24 <- m4sc_hh_24$Total
...
m4sc_hh_24 <- Module_4_Section_C %>%
  filter(Subgroup == "Household Type")%>%
  filter(Year == 2024)%>%
  mutate(`2024 Percent` = round(100*Count / m4sc_hh_total_24, 2))%>%
  rename("2024 Count" = "Count")%>%
  select(!Year)
...
m4sc_hh_joined <- left_join(m4sc_hh_24, m4sc_hh_23, by = c("Group", "Subgroup", "Measure"))
...
m4sc_hh_percent_graph <- long_m4sc_hh_percent_change %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Household Type Percentages")
...
m4sc_hh_percent_change_graph <- long_m4sc_hh_percent_change  %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Household Type Percent Change")
...
m4sc_hh_size_count_graph <- Module_4_Section_C %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Household Size")

m4sc_hh_size_count_graph

m4sc_hh_size_24 <- Module_4_Section_C %>%
  filter(Subgroup == "Household Size")%>%
  filter(Year == 2024)%>%
  summarise(Total = sum(Count))

m4sc_hh_size_total_24 <- m4sc_hh_size_24$Total

m4sc_hh_size_total_24
...
m4sc_hh_size_24 <- Module_4_Section_C %>%
  filter(Subgroup == "Household Size")%>%
  filter(Year == 2024)%>%
  mutate(`2024 Percent` = round(100*Count / m4sc_hh_size_total_24, 2))%>%
  rename("2024 Count" = "Count")%>%
  select(!Year)
...
m4sc_hh_size_joined <- left_join(m4sc_hh_size_24, m4sc_hh_size_23, by = c("Group", "Subgroup", "Measure"))
...
m4sc_hh_size_percent_graph <- long_m4sc_hh_size_percent_change %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Household Size Percentages")
...
m4sc_hh_size_percent_change_graph <- long_m4sc_hh_size_percent_change  %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Household Size Percent Change")
...
m4sc_housing_count_graph <- Module_4_Section_C %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Housing Type")

m4sc_housing_count_graph


m4sc_housing_24 <- Module_4_Section_C %>%
  filter(Subgroup == "Housing")%>%
  filter(Year == 2024)%>%
  summarise(Total = sum(Count))

m4sc_housing_total_24 <- m4sc_housing_24$Total

m4sc_housing_total_24
...
m4sc_housing_type_24 <- Module_4_Section_C %>%
  filter(Subgroup == "Housing")%>%
  filter(Year == 2024)%>%
  mutate(`2024 Percent` = round(100*Count / m4sc_housing_total_24, 2))%>%
  rename("2024 Count" = "Count")%>%
  select(!Year)
...
m4sc_housing_joined <- left_join(m4sc_housing_type_24, m4sc_housing_type_23, by = c("Group", "Subgroup", "Measure"))
...
m4sc_housing_percent_graph <- long_m4sc_housing_percent_change %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Housing Type Percentages")
...
m4sc_housing_percent_change_graph <- long_m4sc_housing_percent_change  %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Housing Type Percent Change")
...
m4sc_hh_income_count_graph <- Module_4_Section_C %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Household Income as Percent of HHS Guideline")

m4sc_hh_income_count_graph

m4sc_hh_income_24 <- Module_4_Section_C %>%
  filter(Subgroup == "Household Incomes (% of HHS Guideline)")%>%
  filter(Year == 2024)%>%
  summarise(Total = sum(Count))

m4sc_hh_income_total_24 <- m4sc_hh_income_24$Total

m4sc_hh_income_total_24
...
m4sc_hh_income_perc_24 <- Module_4_Section_C %>%
  filter(Subgroup == "Household Incomes (% of HHS Guideline)")%>%
  filter(Year == 2024)%>%
  mutate(`2024 Percent` = round(100*Count / m4sc_hh_income_total_24, 2))%>%
  rename("2024 Count" = "Count")%>%
  select(!Year)
...
m4sc_hh_income_joined <- left_join(m4sc_hh_income_perc_24, m4sc_hh_income_perc_23, by = c("Group", "Subgroup", "Measure"))
...
m4sc_hh_income_percent_graph <- long_m4sc_hh_income_percent_change %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Household Income Percentages")
...
m4sc_hh_income_percent_change <- long_m4sc_hh_income_percent_change %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Household Income Percent Change")
...
m4sc_hh_income_sources_count_graph <- Module_4_Section_C %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Sources of Household Income")

m4sc_hh_income_sources_count_graph


m4sc_is_24 <- Module_4_Section_C %>%
  filter(Subgroup == "Sources of Household Income")%>%
  filter(Year == 2024)%>%
  summarise(Total = sum(Count))

m4sc_is_total_24 <- m4sc_is_24$Total
...
m4sc_income_source_24 <- Module_4_Section_C %>%
  filter(Subgroup == "Sources of Household Income")%>%
  filter(Year == 2024)%>%
  mutate(`2024 Percent` = round(100*Count / m4sc_is_total_24, 2))%>%
  rename("2024 Count" = "Count")%>%
  select(!Year)
...
m4sc_income_source_joined <- left_join(m4sc_income_source_24, m4sc_income_source_23, by = c("Group", "Subgroup", "Measure"))
...
m4sc_hh_income_sources_percent_graph <- long_m4sc_income_source_percent_change %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Household Income Source")
...
m4sc_hh_income_sources_percent_change_graph <- long_m4sc_income_source_percent_change  %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Household Income Source Percent Change")
...
m4sc_other_income_source_count_graph <- Module_4_Section_C %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Other Household Income Source")

m4sc_other_income_source_count_graph


m4sc_oi_24 <- Module_4_Section_C %>%
  filter(Subgroup == "Other Income Source")%>%
  filter(Year == 2024)%>%
  summarise(Total = sum(Count))

m4sc_oi_total_24 <- m4sc_oi_24$Total
...
m4sc_oi_source_24 <- Module_4_Section_C %>%
  filter(Subgroup == "Other Income Source")%>%
  filter(Year == 2024)%>%
  mutate(`2024 Percent` = round(100*Count / m4sc_hh_total_24, 2))%>%
  rename("2024 Count" = "Count")%>%
...
m4sc_oi_joined <- left_join(m4sc_oi_source_24, m4sc_oi_source_23, by = c("Group", "Subgroup", "Measure"))
...
m4sc_other_income_percent_graph <- long_m4sc_oi_percent_change %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Other Household Income Percentages")
...
m4sc_other_income_percent_change_graph <- long_m4sc_oi_percent_change  %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Other Household Income Percent Change")
...
m4sc_non_cash_count_graph <- Module_4_Section_C %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Non-Cash Benefits Sources")

m4sc_non_cash_count_graph


m4sc_nc_24 <- Module_4_Section_C %>%
  filter(Subgroup =="Non-Cash Benefits")%>%
  filter(Year == 2024)%>%
  summarise(Total = sum(Count))

m4sc_nc_total_24 <- m4sc_nc_24$Total
...
m4sc_ncb_24 <- Module_4_Section_C %>%
  filter(Subgroup == "Non-Cash Benefits")%>%
  filter(Year == 2024)%>%
  mutate(`2024 Percent` = round(100*Count / m4sc_nc_total_24, 2))%>%
  rename("2024 Count" = "Count")%>%
  select(!Year)
...
m4sc_nc_joined <- left_join(m4sc_ncb_24, m4sc_ncb_23, by = c("Group", "Subgroup", "Measure"))
...
m4sc_non_cash_percent_graph <- long_m4sc_nc_percent_change %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Non-Cash Benefits Percentages")
...
m4sc_non_cash_percent_change_graph <- long_m4sc_nc_percent_change  %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("M4SC 2022-2023 and 2023-2024 Program Year Characteristics: Non-Cash Benefits Percent Change")
...
outcomes_24 <- long_outcomes %>%
  filter(Year == 2024)%>%
  rename("2024 Result" = "Result")%>%
  select(!Year)
...
joined_outcomes <- full_join(outcomes_24, outcomes_23, by = c("Domain", "Outcome", "Measure"))
...
outcomes_education_count_graph <- joined_outcomes %>%
  ...
  group_by(Outcome)%>%
  mutate(`2024-2023 Difference` = `2024 Result` - `2023 Result`)%>%
  mutate(`Percent Change` = round(100*(`2024 Result` - `2023 Result`) / `2023 Result`,2))%>%
  filter(!is.nan(`Percent Change`))%>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("Education Outcomes 2024-2023")
...
edu_outcomes_totals <- joined_outcomes %>%
  ...
  group_by(Outcome)%>%
  filter(Measure == "Total")%>%
  rename("2024 Total" = "2024 Result", "2023 Total" = "2023 Result")%>%
  select(!Measure)
...
joined_edu_with_totals %>%
  ...
  mutate(`2024-2023 Difference` = `2024 Result` - `2023 Result`)%>%
  mutate(`Percent Change` = round(100*(`2024 Result` - `2023 Result`) / `2023 Result`,2))%>%
  mutate(`2024 Percent` = round(100*(`2024 Result` / `2024 Total`),2))%>%
...
education_outcomes_stacked <- joined_edu_with_totals %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("Education Outcomes 2024-2023 as Percentage of Total")
...
education_outcomes_percent_change <- joined_edu_with_totals %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("Education Outcomes 2024-2023 Percent Change")
...
outcomes_emp_count <- joined_outcomes %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("Employment Outcomes 2024-2023")
...
employment_outcomes_stacked_graph <- joined_emp_with_totals %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("Employment Outcomes 2024-2023 as Percentage of Total")
...
employment_outcomes_percent_change_graph <- joined_emp_with_totals %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("Employment Outcomes 2024-2023 Percent Change")
...
joined_outcomes %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("Health and Social/Behavioral Development Outcomes 2024-2023")
...
health_outcomes_stacked_graph <- joined_health_with_totals %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("Health and Social/Behavioral Development Outcomes 2024-2023 as Percentage of Total")
...
health_outcomes_percent_change_graph <- joined_health_with_totals %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("Health Outcomes 2024-2023 Percent Change")
...
joined_outcomes %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("Housing Outcomes 2024-2023")
...
housing_outcomes_stacked_graph <- joined_housing_with_totals %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("Housing Outcomes 2024-2023 as Percentage of Total")
...
housing_outcomes_percent_change <- joined_housing_with_totals %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("Housing Outcomes 2024-2023 Percent Change")
...
joined_outcomes %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("Income and Asset Building Outcomes 2024-2023")
...
income_outcomes_stacked_graph <- joined_income_with_totals %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("Income and Asset Building Outcomes 2024-2023 as Percentage of Total")
...
income_outcomes_percent_change <- joined_income_with_totals %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("Income and Asset Building Outcomes 2024-2023 Percent Change")
...
joined_outcomes %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("Civic Engagement and Community Involvement Outcomes 2024-2023")
...
civic_outcomes_stacked_graph <- joined_civic_with_totals %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("Civic Engagement and Community Involvement Outcomes 2024-2023 as Percentage of Total")
...
joined_civic_with_totals %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("Civic Engagement and Community Involvement Outcomes 2024-2023 Percent Change")
