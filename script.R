...
quarters_labs <- c("Quarter 1 2025", "Quarter 2 2025")
names(quarters_labs) <- c("Quarter 1 2025", "Quarter 2 2025")
...
liheap_plot <- LIHEAP %>%
  mutate(Date = factor(Date, levels = c("Quarter 1 2022", "Quarter 2 2022", "Quarter 3 2022", "Quarter 4 2022","Quarter 1 2023" ,"Quarter 2 2023", "Quarter 3 2023", "Quarter 1 2024",
                                        "Quarter 2 2024", "Quarter 3 2024", "Quarter 4 2024", "Quarter 1 2025", "Quarter 2 2025")))%>%
  mutate(County = factor(County, levels = c("UETHDA", "Carter", "Greene", "Hancock", "Hawkins", "Johnson",
                                            "Sullivan", "Unicoi", "Washington")))%>%
  filter(Date == "Quarter 1 2025"|
           Date == "Quarter 2 2025")%>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(subtitle =  "Navy box is total amount,White box is number of households served", fontface = "italic")+
  ggtitle("LIHEAP Quarter 2 2025 and Quarter 1 2025")  
...
NEW_OUTCOMES %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("Outcomes Quarter 2 2025 and Quarter 1 2025")
...
outcomes_new_quarter <- long_outcomes %>%
  filter(Date == "Quarter 2 2025")%>%
  rename("Quarter 2 2025 Result" = "Result")%>%
  select(!Date)
...
outcomes_totals <- joined_outcomes %>%
  group_by(Outcome)%>%
  filter(Measure == "Total")%>%
  rename("Quarter 2 2025 Total" = "Quarter 2 2025 Result", "Quarter 1 2025 Total" = "Quarter 1 2025 Result")%>%
  select(!Measure)
...
outcomes_count_graph <- joined_with_totals %>%
  group_by(Outcome)%>%
  mutate(`Previous Difference` = `Quarter 2 2025 Result` - `Quarter 1 2025 Result`)%>%
  mutate(`Percent Change` = round(100*(`Quarter 2 2025 Result` - `Quarter 1 2025 Result`) / `Quarter 1 2025 Result`,2))%>%
  mutate(`Current Percent` = round(100*(`Quarter 2 2025 Result` / `Quarter 2 2025 Total`),2))%>%
  mutate(`Previous Percent` = round(100*(`Quarter 1 2025 Result` / `Quarter 1 2025 Result`),2))%>%
  filter(!is.nan(`Percent Change`))%>%
  rename("Quarter_2_2025 Result" = "Quarter 2 2025 Result",
         "Quarter_1_2025 Result" = "Quarter 1 2025 Result",
         "Quarter_2_2025 Total" = "Quarter 2 2025 Total",
         "Quarter_1_2025 Total" = "Quarter 1 2025 Total")%>%
  pivot_longer(-c("Domain", "Outcome", "Measure"), names_to = c("Date", "Type"), values_to = "Value", names_sep = " ")%>%
  filter(Type != "Percent")%>%
  filter(Type != "Total")%>%
  filter(Date == "Quarter_2_2025" |
           Date == "Quarter_1_2025")%>%
  filter(Measure != "Total")%>%
  mutate(Date = str_replace_all(Date, "_", " "))%>%
  mutate(Date = factor(Date, levels = c("Quarter 1 2025", "Quarter 4 2024")))%>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("Outcomes Quarter 2 2025-Quarter 1 2024")
...
outcomes_percent_change <- joined_with_totals %>%
  ...
  mutate(`Percent Change` = round(100*(`Quarter 2 2025 Result` - `Quarter 1 2025 Result`) / `Quarter 1 2025 Result`,2))%>%
  mutate(`Current Percent` = round(100*(`Quarter 2 2025 Result` / `Quarter 2 2025 Total`),2))%>%
  mutate(`Previous Percent` = round(100*(`Quarter 1 2025 Result` / `Quarter 1 2025 Total`),2))%>%
  filter(!is.nan(`Percent Change`))%>%
  rename("Quarter_2_2025 Result" = "Quarter 2 2025 Result",
         "Quarter_1_2025 Result" = "Quarter 1 2025 Result",
         "Quarter_2_2025 Total" = "Quarter 2 2025 Total",
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("Outcomes Percent Change Quarter 2 2025-Quarter 1 2025")
...
outcomes_stacked <- joined_with_totals %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("Outcomes Quarter 2 2025-Quarter 1 2025 as Percentage of Total")
...
outcomes_totals_year <- joined_outcomes_year %>%
  group_by(Outcome)%>%
  filter(Measure == "Total")%>%
  rename("Quarter 2 2025 Total" = "Quarter 2 2025 Result", "Quarter 2 2024 Total" = "Quarter 2 2024 Result")%>%
  select(!Measure)
...
outcomes_count_graph_year <- joined_with_totals_year %>%
  group_by(Outcome)%>%
  mutate(`Previous Difference` = `Quarter 2 2025 Result` - `Quarter 2 2024 Result`)%>%
  mutate(`Percent Change` = round(100*(`Quarter 2 2025 Result` - `Quarter 2 2024 Result`) / `Quarter 2 2024 Result`,2))%>%
  mutate(`Current Percent` = round(100*(`Quarter 2 2025 Result` / `Quarter 2 2025 Total`),2))%>%
  mutate(`Previous Percent` = round(100*(`Quarter 2 2024 Result` / `Quarter 2 2024 Total`),2))%>%
  filter(!is.nan(`Percent Change`))%>%
  rename("Quarter_2_2025 Result" = "Quarter 2 2025 Result",
  ...
  filter(Date == "Quarter_2_2025" |
           Date == "Quarter_2_2024")%>%
  mutate(Date = str_replace_all(Date, "_", " "))%>%
  mutate(Date = factor(Date, levels = c("Quarter 2 2025", "Quarter 2 2024")))%>%
  filter(Measure != "Total")%>%
  ggplot(aes(x = Value, y = Outcome, fill = Measure))+
  geom_bar(stat = "identity", position="dodge")+
  facet_grid(~Date, labeller = labeller(Date = quarters_labs))+
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("Outcomes Quarter 2 2025-Quarter 2 2024")
...
outcomes_percent_change_year <- joined_with_totals_year %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("Outcomes Percent Change Quarter 2 2025-2024")
...
outcomes_stacked_year <- joined_with_totals_year %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("Outcomes Quarter 2 2025-2024 as Percentage of Total")
...
outreach <- OUTREACH %>%
  ...
  geom_label(aes(group = Action, label = Count), position = position_dodge(width = 1), fill = "white")+
  labs(y = " ", x = " ")+
  ggtitle("LIHEAP Outreach Quarter 2 2025 and Quarter 1 2025")+
  theme(plot.title = element_text(size = rel(2.25)))+
  theme(plot.title = element_text(face = "bold"))+
  theme(axis.text.x = element_text(size = rel(1.5)))+
  theme(axis.text.x = element_text(face = "bold"))+
...
wap <- WAP %>%
  ...
  theme(plot.subtitle = element_text(size = rel(1.5)))+
  theme(plot.subtitle = element_text(face = "italic"))+
  ggtitle("Weatherization Quarter 2 2025 and Quarter 1 2025")
...
first_steps_outcomes <- FIRST_STEPS %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("First Steps Outcomes Quarter 2 2025 and Quarter 1 2025")
...
joined_first_steps_with_totals %>%
  ...
  filter(Date == "Quarter_2_2025" |
           Date == "Quarter_1_2025")%>%
  mutate(Date = str_replace_all(Date, "_", " "))%>%
  mutate(Date = factor(Date, levels = c("Quarter 2 2025", "Quarter 1 2025")))%>%
  filter(Measure != "Total")%>%
  ggplot(aes(x = Value, y = Outcome, fill = Measure))+
  geom_bar(stat = "identity", position="dodge")+
  facet_grid(~Date, labeller = labeller(Date = quarters_labs))+
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("First Steps Outcomes Quarter 2 2025-Quarter 1 2025")
...
joined_first_steps_with_totals %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("First Steps Percent Change Quarter 2 2025-Quarter 1 2025")
...
joined_first_steps_with_totals %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("First Steps Quarter 2 2025-Quarter 1 2024 as Percentage of Total")
...
liheap_plot_previous_year <- LIHEAP %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(subtitle =  "Navy box is total amount,White box is number of households served", fontface = "italic")+
  ggtitle("LIHEAP Quarter 2 2025 and Quarter 2 2024")  
...
outcomes_previous_year <- NEW_OUTCOMES %>%
  ...
  theme(legend.text = element_text(face = "bold"))+
  labs(y = " ", x = " ")+
  ggtitle("CSBG Outcomes Quarter 2 2025 and Quarter 2 2024")
...
outreach_previous_year <- OUTREACH %>%
  ...
  geom_label(aes(group = Action, label = Count), position = position_dodge(width = 1), fill = "white")+
  labs(y = " ", x = " ")+
  ggtitle("LIHEAP Outreach Quarter 2 2025 and Quarter 2 2024")+
  theme(plot.title = element_text(size = rel(2.25)))+
  theme(plot.title = element_text(face = "bold"))+
  theme(axis.text.x = element_text(size = rel(1.5)))+
  theme(axis.text.x = element_text(face = "bold"))+
...
wap_previous_year <- WAP %>%
  ...
  theme(plot.subtitle = element_text(size = rel(1.5)))+
  theme(plot.subtitle = element_text(face = "italic"))+
  ggtitle("Weatherization Quarter 2 2025 and Quarter 2 2024")
